...
5. 编辑jekyll创建的gemfile文件
   ...
   2. 编辑以`# gem "github-pages"`开头的行，以添加`github-pages`gem。将此行更改为`gem "github-pages", "~> GITHUB-PAGES-VERSION", group: :jekyll_plugins`
   3. 其中`GITHUB-PAGES-VERSION`（目前最新的是228）为最新支持的版本，通过这里查看[版本](https://pages.github.com/versions/ "https://pages.github.com/versions/")
   4. 保存并关闭gemfile
...
8. 如果要预览网站，需要在浏览器中打开[http://localhost:4000](http://localhost:4000 "http://localhost:4000")
